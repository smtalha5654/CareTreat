...
final userRef3 = FirebaseFirestore.instance.collection('nurses');
...
class _NurseScreenState extends State<NurseScreen> {
  ...
  Future<void> getFCMToken() async {
    ...
    //addFMC
    userRef3.doc(id).get().then((DocumentSnapshot doc) async {
      if (doc.exists) {
        //updateFMC
                        ...
                        InkWell(
                          onTap: () {
                            Navigator.push(context,
                                MaterialPageRoute(builder: (context) {
                              return const CreateNurseProfile();
                            }));
                          },
                          child: Container(
                            decoration: BoxDecoration(
            ...
            isLoaded
                ? Expanded(
                    child: items.isEmpty
                        ? Center(
                            child: Text(
                              'Dear $fname $lname \nClick \'Create Nurse Profile\' to set up your professional information. For scheduling, use \'Create Working Schedule\' to input your availability. Currently, no house visits are scheduled, ensuring you can manage your time effectively',
